...
class _FactureDetailsState extends State<FactureDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Padding(
        padding: const EdgeInsets.only(top: 25,right: 15,left: 15,bottom: 10),
          ...
          child: Column(
            children: [
              Row(
                children: const [
                  ...
                  //  textAlign: TextAlign.center,
                     style:TextStyle(fontWeight:FontWeight.bold,fontSize: 20,color: Color(0xff2E9FB0)),),
                ],
              ),
              ...
              Text(
                ...
                textAlign: TextAlign.center,
                style:TextStyle(fontSize: 20, fontWeight: FontWeight.bold,color:Color(0xff2E9FB0),),),
              Padding(
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        "Prix Total :",
                        textAlign: TextAlign.center,
                        style:TextStyle(fontSize: 20,color: Color(0xff042A2B),fontWeight: FontWeight.bold)),
                      SizedBox(width: 5,),
                      Text(
                        "${widget.montant} DA",
                        textAlign: TextAlign.center,
                        style:TextStyle(fontSize: 23,color: Color(0xff042A2B)),)
                    ],
                  )
              ),
              SizedBox(height: size.height*0.03,),
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    Column(
                      children: [
                        Text(" Numero de chasis : ", textAlign: TextAlign.center,style:TextStyle(fontSize: 16,fontWeight: FontWeight.bold)),
                    ...
                    Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Text(" Type de vehicule : ", textAlign: TextAlign.center,style:TextStyle(fontSize: 16,fontWeight: FontWeight.bold)),
                        SizedBox(height: size.height*0.008,),
